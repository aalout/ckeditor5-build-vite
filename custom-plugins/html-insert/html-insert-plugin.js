import {Plugin, ButtonView, Collection, createDropdown, ViewModel} from 'ckeditor5';
...
export default class HtmlInsertPluginDr extends Plugin {
  ...
  _insertHtmlElement( eventInfo ) {
    ...
    this.editor.model.change( writer => {
      writer.insert( htmlElement, this.editor.model.document.selection.getFirstPosition() );
    } );
  }
}